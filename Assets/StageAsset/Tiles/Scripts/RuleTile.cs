...
[Serializable]
[CreateAssetMenu(fileName = "RuleTile", menuName = "Tile/RuleTile", order = 1)]
public class RuleTile : TileBase
{
    HashSet<Vector3Int> nullPosition = new HashSet<Vector3Int>();


    public void SetNull(Vector3Int vector3Int) { nullPosition.Add(vector3Int); }

    public void DeleteNull() { nullPosition.Clear(); }
	...
	{
        if (nullPosition.Contains(position))
        {
            return;
        }
