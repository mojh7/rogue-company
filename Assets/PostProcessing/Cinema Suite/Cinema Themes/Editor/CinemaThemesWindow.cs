...
#region Language
    ...
    private const string MISSING_COMPONENT_ERROR_MSG =
#if !UNITY_5 && !UNITY_2017_1_OR_NEWER
        "Color Correction Component not found! \nPlease add the package by navigating to Assets > Import Package > Image Effects.";
#elif UNITY_5 && !UNITY_5_5_OR_NEWER
        "Color Correction Component not found! \nPlease add the package by navigating to Assets > Import Package > Effects.";
